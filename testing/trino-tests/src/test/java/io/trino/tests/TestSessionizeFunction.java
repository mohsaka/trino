...
import static io.trino.operator.table.SessionizeFunction.SessionizeFunctionSplit.DEFAULT_SPLIT_SIZE;
import static io.trino.testing.TestingSession.testSessionBuilder;
import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

public class TestSessionizeFunction
        extends AbstractTestQueryFramework
{
    ...
    @Test
    public void testSessionizeFunction()
    {
        assertThat(query("SELECT * FROM TABLE(sessionize(1, 10, 3))"))
                .matches("VALUES BIGINT '1', 4, 7, 10");

        assertThat(query("SELECT * FROM TABLE(sessionize(1, 10, 6))"))
        ...
        assertThat(query("SELECT * FROM TABLE(sessionize(-5, 5, 3))"))
                .matches("VALUES BIGINT '-5', -2, 1, 4");

        assertThat(query("SELECT * FROM TABLE(sessionize(5, -5, -3))"))
                .matches("VALUES BIGINT '5', 2, -1, -4");

        assertThat(query("SELECT * FROM TABLE(sessionize(0, 10, 3))"))
